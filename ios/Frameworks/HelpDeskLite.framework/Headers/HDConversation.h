 ...
 */
typedef enum{
    HDMessageSearchDirectionUp  = 0,    /*! \~chinese 向上搜索 \~english Search older messages */
    HDMessageSearchDirectionDown        /*! \~chinese 向下搜索 \~english Search newer messages */
} HDMessageSearchDirection;
...
typedef enum : NSUInteger {
    HSessionType_Prepare,
    HSessionType_Wait,
    HSessionType_Scheduling,
    HSessionType_Processing,
    HSessionType_Terminal,
    HSessionType_Transfer,
    HSessionType_Abort,
    HSessionType_Resolved
} HSessionType;
...
- (void)insertMessage:(HDMessage *)aMessage
                error:(HDError **)pError __attribute__((deprecated("已过期, 请使用addMessage")));
 ...
 *  @param pError   Error
 */
- (void)addMessage:(HDMessage *)aMessage
             error:(HDError **)pError;


- (void)deleteMessageWithId:(NSString *)aMessageId
                      error:(HDError **)pError __attribute__((deprecated("已过期, 请使用removeMessageWithMessageId")));
/*!
 *  \~chinese
 *  删除一条消息
 *
 ...
 *
 */
- (void)updateMessageChange:(HDMessage *)aMessage
                      error:(HDError **)pError;
 ...
 *
 */
- (HDMessage *)loadMessageWithId:(NSString *)aMessageId
                          error:(HDError **)pError;
...
- (void)loadMessagesStartFromId:(NSString *)aMessageId
                          count:(int)aCount
                searchDirection:(HDMessageSearchDirection)aDirection
                     completion:(void (^)(NSArray *aMessages, HDError *aError))aCompletionBlock;
...
- (void)loadMessagesWithType:(EMMessageBodyType)aType
             ...
             searchDirection:(HDMessageSearchDirection)aDirection
                  completion:(void (^)(NSArray *aMessages, HDError *aError))aCompletionBlock __attribute__((deprecated("已过期")));
/*!
 *  \~chinese
