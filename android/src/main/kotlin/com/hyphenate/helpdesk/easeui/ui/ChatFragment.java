...
//        });
    ...
    protected void registerExtendMenuItem() {
        for (int i = 0; i < itemStrings.length; i++) {
            inputMenu.registerExtendMenuItem(itemStrings[i], itemdrawables[i], itemIds[i], itemResIds[i], (ExtendMenu.EaseChatExtendMenuItemClickListener) extendMenuItemClickListener);
        }
    }
